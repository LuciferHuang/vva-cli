<template>
  <div class="login-wrap">
      ...
      <el-form ref="formRef" :model="state.form" :rules="rules">
        <el-form-item prop="user">
          <el-input
            ...
            @blur="userActive = !!state.form.user"
            @keyup="keyNext($event)"
          ></el-input>
    ...
    <div class="footer">
      <p class="copy-right">Copyright &copy; 2020 &nbsp;Hlianfa</p>
    </div>
  </div>
</template>
<script lang="ts">
...
export default defineComponent({
  ...
  setup() {
      ...
      formRef.value.validate((valid: boolean) => {
        if (valid) {
          ...
          http
            ...
            .then((res: any) => {
              const { __mtoken, user_info } = res;
              setCookie(USER_TOKEN_KEY, __mtoken, 7);
    ...
    const validateUser = (rule, value: string, callback: Function) => {
