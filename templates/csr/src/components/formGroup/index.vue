  ...
  >
    ...
    >
      <el-input
        ...
        :placeholder="item.placeholder || $t('component.inputPlaceholder')"
        clearable
      ...
      <select-box
        ...
        :placeholder="item.placeholder || $t('component.selectPlaceholder')"
    ...
    function initRules() {
      ...
      props.formItems.forEach((item) => {
        ...
        if (minLength || maxLength) {
          ...
          if (minLength && maxLength) {
            message = `${t(
              "component.rangeLengthPre"
            )}${minLength}-${maxLength}${t("component.rangeLengthEnd")}`;
          } else if (minLength && !maxLength) {
            message = `${t("component.minLengthPre")}${minLength}${t(
              "component.minLengthEnd"
            )}`;
          } else {
            message = `${t("component.maxLengthPre")}${minLength}${t(
              "component.maxLengthEnd"
            )}`;
          }
          propRule.push({
            min: minLength || 0,
